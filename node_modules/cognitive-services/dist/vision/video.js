...
var video = function (_commonService) {
    _inherits(video, _commonService);
    ...
    function video(_ref) {
        ...
        _this.serviceId = "565d6516778daf15800928d5";
    ...
    */
    ...
    video.prototype.faceDetectionAndTracking = function faceDetectionAndTracking(_ref2) {
        var _this2 = this;
    ...
    */
    video.prototype.getOperationResult = function getOperationResult(_ref3) {
    ...
    @returns {Promise.<Object>}
    */
    video.prototype.getResultVideo = function getResultVideo(_ref4) {
    ...
    */
    video.prototype.motionDetection = function motionDetection(_ref5) {
        var _this3 = this;
    ...
    - Output files are deleted after 24 hours.
     @returns {Promise.<string>}  ID of operation
    */
    video.prototype.stabilization = function stabilization(_ref6) {
        var _this4 = this;
     ...
     * Generates a motion thumbnail from a video. The Video Thumbnail API provides an automatic summary for videos to let people see a preview or snapshot quickly. Selection of scenes from a video create a preview in form of a short video. 
     ...
     @returns {Promise.<string>}  ID of operation
        */
    video.prototype.thumbnail = function thumbnail(_ref7) {
        var _this5 = this;
        ...
        return this.makeRequest({
            ...
            return _this5.getOperationIdFromUrl(operationIdUrl);
        });
    };
